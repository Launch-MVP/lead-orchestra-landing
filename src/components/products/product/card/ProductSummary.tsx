...
> = {
	fear: {
		label: "Fear Signal",
		icon: buildIcon("Fear signal", "h-4 w-4 text-red-600 dark:text-red-400", [
			<path
				key="fear-x"
				strokeLinecap="round"
	...
	hope: {
		label: "Hope Moment",
		icon: buildIcon("Hope moment", "h-4 w-4 text-sky-600 dark:text-sky-400", [
			<path
				key="hope-hand"
				strokeLinecap="round"
				strokeLinejoin="round"
	...
	solution: {
		...
		content:
			"px-4 text-sm leading-relaxed text-emerald-800 dark:text-emerald-100",
	},
};
