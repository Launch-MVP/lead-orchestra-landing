		...
		faqs: [
			{
				...
				answer:
					"All templates are provided in Word and PDF formats for easy editing.",
			},
		],
		physical: false,
	},
		...
		faqs: [
			{
				...
				answer:
					"No, this is a toolkit for managing the process, not a legal service.",
			},
		],
		physical: false,
	},
		...
		faqs: [
			{
				...
				answer:
					"Minimal assembly is required. Instructions and tools are included.",
			},
		],
		physical: true,
	},
