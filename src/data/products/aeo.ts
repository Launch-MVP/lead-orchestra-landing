...
export const aeoProducts: ProductType[] = [
    // Tier 0: Free Content Calendar
    {
        ...
        categories: [ProductCategory.Templates, ProductCategory.SeoAeo, ProductCategory.FreeResources],
        images: [
            'https://images.unsplash.com/photo-1506784983877-45594efa4cbe?w=800&h=600&fit=crop&q=80', // Calendar/Planning
        ],
        types: [
            { name: 'Free Download', value: 'free', price: 0 }
        ],
        reviews: [],
        ...
        faqs: [
            {
                ...
                answer: 'Yes—download it free. If you want us to implement the full engine, you can request a build.'
            },
            {
                question: 'What makes it AEO-friendly?',
                answer: 'It’s organized around target questions, answer-first structure, and "extractable" formatting prompts—so content is easier to cite.'
            },
            {
                question: 'Does it include internal linking guidance?',
                answer: 'Yes. Each post includes slots for internal links so your site becomes a connected library over time.'
            }
        ],
