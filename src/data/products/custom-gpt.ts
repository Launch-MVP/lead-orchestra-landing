		...
		faqs: [
			{
				...
				answer:
					"No, it’s a structured output system with scoring + templates + CTA/link rules. It is designed to be a repeatable workflow with built-in QA.",
			},
			{
				question: "Will it match my voice?",
				answer:
					"It includes a voice guide you fill in so you can configure it yourself. For true, deep alignment done-for-you, check out the Standard Build.",
			},
			{
			...
			},
			{
				...
				answer:
					"It includes an event naming plan you can implement. Full implementation is available in the Standard/Engine tiers.",
			},
		],
	},
	{
		...
		categories: [ProductCategory.SeoAeo, ProductCategory.Agents],
		images: [
		...
		faqs: [
			{
				...
				answer:
					"The template gives you the framework. The Standard Build makes it YOURS—your voice, your specific offers, and your actual internal links, all configured and QA’d by us.",
			},
			{
			...
			},
			{
				...
				answer:
					"We provide a comprehensive event plan and can help wire it to Google Analytics, Plausible, or Microsoft Clarity.",
			},
			{
				question: "How many posts does it support?",
				answer:
					"As many as you want. The Standard Build is about setting up a quality, repeatable engine you can run forever.",
			},
		],
	},
	{
		...
		faqs: [
			{
				...
				answer:
					"Not necessarily. Most setups are low-code/no-code. If deeper custom integrations are needed, we scope that specifically.",
			},
			{
				question: "What’s included that Standard doesn’t have?",
				answer:
					'Automated topic sourcing, dynamic content calendar generation, "publish packs" for distribution, and a full tracking/indexing workflow.',
			},
			{
			...
			},
			{
				...
				answer:
					"Through rigorous guardrails, automated scoring, and a mandatory human approval queue. We value trust over raw volume.",
			},
		],
	},
];
